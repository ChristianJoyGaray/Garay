...
# Security Groups
resource "aws_security_group" "cp_301_302_sg" {
  name        = "cp_301_302_sg"
...
resource "aws_instance" "cp_301_302_sg" {
  ami                         = "ami-06e85d4c3149db26a"
  instance_type               = "t2.micro"
  subnet_id                   = aws_subnet.private_subnets["cp_301_302_sg"].id
  security_groups             = [aws_security_group.cp_301_302_sg.id]
